...
import type {PublickFile} from "@workspace/backend/private/files"
...
export const FilesView = () => {
    ...
    const [fileToDelete, setFileToDelete] = useState<PublickFile | null>(null)

    const handleDeleteFile = (file: PublickFile) => {
  ...
  return (
    <>
        ...
        />
        <div className='flex min-h-screen flex-col bg-muted p-8 w-full'>
        <div className="mx-auto w-full">
            ...
            <div className="mt-8 rounded-lg border bg-background">
                ...
                {
                    !isLoadingFirsPage && files.results.length > 0 && (
