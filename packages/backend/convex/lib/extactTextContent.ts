...
const SYSTEM_PROMPTS = {
    ...
    html: "You transform content files into markdown."
}
...
export async function extactTextContent(ctx: {storage: StorageActionWriter}, args: ExtractTextContentArgs): Promise<string> {
    const {
        storageId,
        filename,
        bytes,
